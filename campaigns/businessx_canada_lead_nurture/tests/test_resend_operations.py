...
def mock_httpx_client():
    ...
    with patch('campaigns.businessx_canada_lead_nurture.tasks.resend_operations.httpx.Client') as mock_client:
        yield mock_client
...
class TestRetryLogic:
    ...
    def test_retry_annotation_exists(self):
        ...
        import inspect
        from campaigns.businessx_canada_lead_nurture.tasks import resend_operations
